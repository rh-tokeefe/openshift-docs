...
= Migrating a cluster-wide deployment using the simple migration method 
...
[NOTE]
====
Using the simple migration method to migrate from  {SMProduct} 2 to  {SMProduct} 3 will result in traffic disruption to the services running on a mesh. 
====
