...
[id="next-steps-istio-revision-tasks_{context}"]
== Next steps
...
//Migration tasks using the Istio injection label
...
[id="next-steps-istio-injection-tasks_{context}"]
== Next steps
...
//Migration tasks using the simple migration method
...
[id="next-steps-simple-migration-tasks_{context}"]
== Next steps
